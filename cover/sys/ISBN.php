...
class ISBN
{
    ...
    public function __construct($raw)
    {
        ...
        //$logger->log("ISBN_raw: " . print_r($this->_raw,1),  PEAR_LOG_DEBUG);
    }
    ...
    public function get13()
    {
    	...
    	//$logger->log("inside get(13) " ,  PEAR_LOG_DEBUG);
        // Is it valid?
        if ($this->isValid()) {
        	//$logger->log("inside get(13) valid" ,  PEAR_LOG_DEBUG);
        ...
        //$logger->log("inside get(13) not valid" ,  PEAR_LOG_DEBUG);
